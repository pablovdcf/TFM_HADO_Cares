...
def rename_columns(data: pd.DataFrame, year: int, rename_map: Dict[str, str]) -> pd.DataFrame:
    """
    ...
    print(f'Year for the DataFrame: {year}') # Asumiendo que el año es el nombre del DataFrame
