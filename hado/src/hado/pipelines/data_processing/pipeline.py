...
from .nodes import clean_text, replace_missing, replace_words, process_fecha_alta, asignar_medicamentos, asignar_sedacion, encoding_variables, apply_categorization, apply_combined_otros_categorization
...
def create_pipeline_data_processing(**kwargs):
    return Pipeline(
        [
            ...
            node(
                func=apply_combined_otros_categorization,
                inputs="hado_categorized",
                outputs="hado_final",
